...
import (
	...
	"github.com/tenderly/net-sonic-geth/crypto/signify"
	"github.com/tenderly/net-sonic-geth/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/tenderly/net-sonic-geth/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/tenderly/net-sonic-geth/internal/version.gitDate="+env.Date)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/tenderly/net-sonic-geth/core/rawdb", "github.com/tenderly/net-sonic-geth/ethdb/leveldb"},
		{"github.com/tenderly/net-sonic-geth/core/rawdb", "github.com/tenderly/net-sonic-geth/ethdb/pebbledb"},
	}
	tc := new(build.GoToolchain)
