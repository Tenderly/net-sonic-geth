...
[![API Reference](
https://pkg.go.dev/badge/github.com/tenderly/net-sonic-geth
)](https://pkg.go.dev/github.com/tenderly/net-sonic-geth?tab=doc)
[![Go Report Card](https://goreportcard.com/badge/github.com/tenderly/net-sonic-geth)](https://goreportcard.com/report/github.com/tenderly/net-sonic-geth)
...
For more detailed instructions please see the `website` branch [README](https://github.com/tenderly/net-sonic-geth/tree/website#readme) or the 
